...
const stockLedgerSchema = new mongoose.Schema({
  ...
  source: {
    type: String,
    enum: ['GRN', 'SALE', 'TRANSFER', 'ADJUSTMENT', 'RETURN', 'PURCHASE_RETURN', 'SALES_RETURN', 'DELIVERYCHALLAN', 'SUPPLIER_OUTWARD', 'SUPPLIEROUTWARD', 'PRODUCTION_RECEIPT', 'DISPATCH', 'OPENING_BALANCE'],
    required: true
  },
  referenceId: {
