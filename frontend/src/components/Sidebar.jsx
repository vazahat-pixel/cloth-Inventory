          ...
          <Box key={item.path}>
            ...
            {item.path === '/masters' && (
              <Collapse in={showMastersChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {mastersNavigationItems.map((child) => (
            ...
            {item.path === '/purchase' && (
              <Collapse in={showPurchaseChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {purchaseNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
            ...
            {item.path === '/sales' && (
              <Collapse in={showSalesChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {salesNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
            ...
            {item.path === '/customers' && (
              <Collapse in={showCustomersChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {customersNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
            ...
            {item.path === '/settings' && (
              <Collapse in={showSettingsChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {settingsNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
            ...
            {item.path === '/reports' && (
              <Collapse in={showReportsChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {reportsNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
            ...
            {item.path === '/pricing' && (
              <Collapse in={showPricingChildren} timeout="auto" unmountOnExit>
                <List disablePadding sx={{ pl: 1, pr: 0.5, pb: 0.5 }}>
                  {pricingNavigationItems.map((child) => (
                    <ListItem key={child.path} disablePadding sx={{ mb: 0.25 }}>
                      <ListItemButton
                        component={NavLink}
                        to={child.path}
