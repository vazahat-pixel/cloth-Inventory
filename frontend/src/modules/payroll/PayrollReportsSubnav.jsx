...
import { payrollReportsNavItems } from './payrollReportsNavConfig';

function PayrollReportsSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {payrollReportsNavItems.map((item) => {
...
export default PayrollReportsSubnav;
