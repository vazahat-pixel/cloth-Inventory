...
import { configurationsNavItems } from './configurationsNavConfig';

function ConfigurationsSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {configurationsNavItems.map((item) => {
...
export default ConfigurationsSubnav;
