...
import { orderProcessingNavItems } from './orderProcessingNavConfig';

function OrderProcessingSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {orderProcessingNavItems.map((item) => {
...
export default OrderProcessingSubnav;
