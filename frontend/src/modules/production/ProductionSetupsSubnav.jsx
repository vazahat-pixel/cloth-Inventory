...
import { productionSetupsNavItems } from './productionSetupsNavConfig';

function ProductionSetupsSubnav() {
  ...
  return (
    ...
    >
      <Box sx={{ px: 1.5, py: 1.5 }}>
        <Box sx={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: 1 }}>
          ...
          <Button
            ...
            onClick={() => appNavigate('/production')}
            sx={{
              minWidth: 0,
              px: 1,
              py: 0.35,
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {productionSetupsNavItems.map((item) => {
...
export default ProductionSetupsSubnav;
