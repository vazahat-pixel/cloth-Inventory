...
import { accountsUtilitiesNavItems } from './accountsUtilitiesNavConfig';

function AccountsUtilitiesSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {accountsUtilitiesNavItems.map((item) => {
...
export default AccountsUtilitiesSubnav;
