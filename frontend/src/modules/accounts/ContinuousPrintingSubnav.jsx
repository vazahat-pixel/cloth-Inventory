...
import { continuousPrintingNavItems } from './continuousPrintingNavConfig';

function ContinuousPrintingSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {continuousPrintingNavItems.map((item) => {
...
export default ContinuousPrintingSubnav;
