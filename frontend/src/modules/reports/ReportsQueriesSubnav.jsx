...
import { reportsQueriesNavItems } from './reportsQueriesNavConfig';

function ReportsQueriesSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {reportsQueriesNavItems.map((item) => {
...
export default ReportsQueriesSubnav;
