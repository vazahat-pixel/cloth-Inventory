...
import { financialReportsNavItems } from './financialReportsNavConfig';

function FinancialReportsSubnav() {
  ...
  return (
    ...
    >
      ...
      <List disablePadding sx={{ px: 0.9, pb: 1.5 }}>
        {financialReportsNavItems.map((item) => {
